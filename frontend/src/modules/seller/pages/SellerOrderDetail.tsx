...
export default function SellerOrderDetail() {
  ...
  const handleExportPDF = () => {
    ...
    doc.text('Jasti - 10 Minute App', margin + 5, yPos + 10);
    ...
    doc.setFontSize(12);
    doc.setFont('helvetica', 'bold');
    doc.text('Jasti - 10 Minute App', margin, yPos);
    yPos += 7;
    ...
    yPos += 5;
    doc.setFontSize(10);
    doc.text('From: Jasti - 10 Minute App', margin, yPos);
    yPos += 5;
    ...
    doc.text('Bill Generated by Jasti - 10 Minute App', pageWidth / 2, yPos, { align: 'center' });
    yPos += 5;
    doc.setFontSize(10);
    doc.text('Copyright © 2025. Developed By Jasti - 10 Minute App', pageWidth / 2, yPos, { align: 'center' });
        ...
        <div className="bg-white px-4 sm:px-6 py-6">
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-6 mb-6">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                ...
                <div>
                  <div className="text-xs text-green-600 font-semibold">Jasti</div>
                  <div className="text-[10px] text-green-600">in 10 Minutes</div>
                </div>
              </div>
              <h1 className="text-2xl sm:text-3xl font-bold text-neutral-900 mb-2">Jasti - 10 Minute App</h1>
              <div className="space-y-1 text-sm text-neutral-600">
                <p>
                  <span className="font-medium">From:</span> Jasti - 10 Minute App
                </p>
                <p>
          ...
          <div className="border-t border-dashed border-neutral-300 pt-4">
            <p className="text-sm text-neutral-600 text-center">
              Bill Generated by Jasti - 10 Minute App
            </p>
          </div>
        </div>
      </div>
