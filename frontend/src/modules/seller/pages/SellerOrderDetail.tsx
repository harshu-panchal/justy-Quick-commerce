...
export default function SellerOrderDetail() {
  ...
  const handleExportPDF = () => {
    ...
    doc.text('Zeto Mart - 10 Minute App', margin + 5, yPos + 10);
    ...
    doc.setFontSize(12);
    doc.setFont('helvetica', 'bold');
    doc.text('Zeto Mart - 10 Minute App', margin, yPos);
    yPos += 7;

    doc.setFontSize(10);
    doc.setFont('helvetica', 'normal');
    doc.text('From: Zeto Mart - 10 Minute App', margin, yPos);
    yPos += 6;
    doc.text('Phone: 8956656429', margin, yPos);
    yPos += 6;
    doc.text('Email: info@Zeto Mart.com', margin, yPos);
    yPos += 6;
    doc.text('Website: https://Zeto Mart.com', margin, yPos);
    yPos += 12;
    ...
    doc.text('Bill Generated by Zeto Mart - 10 Minute App', pageWidth / 2, yPos, { align: 'center' });
    yPos += 8;

    doc.setFontSize(8);
    doc.text('Copyright © 2025. Developed By Zeto Mart - 10 Minute App', pageWidth / 2, yPos, { align: 'center' });
        ...
        <div className="bg-white px-4 sm:px-6 py-6">
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-6 mb-6">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                ...
                <div>
                  <div className="text-xs text-green-600 font-semibold">Zeto Mart</div>
                  <div className="text-[10px] text-green-600">in 10 Minutes</div>
                </div>
              </div>
              <h1 className="text-2xl sm:text-3xl font-bold text-neutral-900 mb-2">Zeto Mart - 10 Minute App</h1>
              <div className="text-sm text-neutral-600 mb-1">
                <span className="font-medium">From:</span> Zeto Mart - 10 Minute App
              </div>
              <div className="text-sm text-neutral-600 space-y-1">
                ...
                <div>
                  <span className="font-medium">Email:</span> info@Zeto Mart.com
                </div>
                <div>
                  <span className="font-medium">Website:</span> https://Zeto Mart.com
                </div>
              </div>
            </div>
          ...
          <div className="border-t border-dashed border-neutral-300 pt-4">
            <p className="text-sm text-neutral-600 text-center">
              Bill Generated by Zeto Mart - 10 Minute App
            </p>
          </div>
        </div>
      </div>
