        ...
        <div className="pb-24 md:pb-8 bg-white min-h-screen">
            ...
            <div className="px-4 md:px-6 lg:px-8 py-6 max-w-3xl mx-auto">
                ...
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-3xl font-bold text-neutral-900 mb-2">Zeto Mart</h2>
                ...
                <div className="mb-8">
                    ...
                    <p className="text-sm text-neutral-700 leading-relaxed">
                        At Zeto Mart, we're committed to revolutionizing the way you shop and receive your products.
                ...
                <div className="mb-8">
                    ...
                    <p className="text-sm text-neutral-700 leading-relaxed mb-4">
                        Zeto Mart is a comprehensive e-commerce platform that connects customers with a wide range
                ...
                <div className="mt-8 text-center">
                    ...
                    <p className="text-xs text-neutral-500 mt-1">© 2024 Zeto Mart. All rights reserved.</p>
                </div>
            </div>
        </div>
    );
