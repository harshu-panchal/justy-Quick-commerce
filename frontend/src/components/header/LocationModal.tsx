                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center justify-between">
                                        ...
                                        {!isEditingPincode ? (
                                            ...
                                            <PincodeSelector onPincodeChange={handlePincodeChange} />
                                        )}
                                    </div>
                                    {isEditingPincode && (
                                    ...
                                    {!isEditingPincode && (
                                        <p className="text-xs text-neutral-500 font-medium">
                                            Enter a 6-digit pincode to update delivery availability.
                                        </p>
                                    )}
                                    {isEditingPincode && (
                                        <p className="text-xs text-neutral-500 font-medium">
                                            Enter a 6-digit pincode and press Enter or tap outside to save.
                                        </p>
                                    )}
                                </div>
                            </div>
