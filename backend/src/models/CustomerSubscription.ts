...
CustomerSubscriptionSchema.index({ customerId: 1, status: 1, createdAt: -1 });

export default mongoose.model<ICustomerSubscription>("CustomerSubscription", CustomerSubscriptionSchema);
