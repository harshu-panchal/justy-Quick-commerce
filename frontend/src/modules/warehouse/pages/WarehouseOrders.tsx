...
const OrderItem = ({ order, delay, onHandover, onPack }: { 
  ...
  <motion.div
    ...
    transition={{ delay }}
    className="bg-white rounded-3xl p-6 shadow-sm border border-neutral-100 hover:shadow-xl hover:border-teal-100 transition-all group"
  >
    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
      <div className="flex items-center gap-4">
        <div className="w-14 h-14 rounded-2xl bg-teal-50 flex items-center justify-center text-3xl border border-teal-100 group-hover:bg-teal-600 group-hover:text-white transition-all duration-300">
        ...
        <div className="flex flex-col md:flex-row gap-4 flex-1 md:max-w-2xl justify-end">
          <div className="relative flex-1">
            <input
              ...
              className="w-full bg-white border-2 border-neutral-100 focus:border-teal-500 rounded-2xl py-3 px-12 font-bold outline-none transition-all shadow-sm"
            />
          ...
          <div className="flex p-1 bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-x-auto">
            {categories.map(cat => (
              <button
                ...
                className={`px-6 py-2 text-xs font-black rounded-xl transition-all flex-shrink-0 ${filter === cat ? 'bg-teal-600 text-white shadow-lg' : 'text-neutral-500 hover:bg-neutral-50'
                  }`}
              >
                {cat}
              </button>
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <button
                  ...
                  className={`w-full py-6 rounded-[32px] font-black text-xl transition-all shadow-xl active:scale-95 ${riderOtp.length === 4 && !verifying
